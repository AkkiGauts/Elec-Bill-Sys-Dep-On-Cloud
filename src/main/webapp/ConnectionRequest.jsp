					...
					<table class="table table-hover">
						...
						<tbody>
							<tr>
								...
								<%if(rs.getString("request").equals("pending"))
								{
									%>
								<td><a
									href="approveRequest?name=<%=rs.getString("cname")%>&&email=<%=rs.getString("cemail")%>">
										<button type="button" class="btn btn-danger delete">Approve</button>
								</a></td>

								<td><a
									href="declineRequest?name=<%=rs.getString("cname")%>&&email=<%=rs.getString("cemail")%>">
										<button type="button" class="btn btn-danger delete">Decline</button>
								</a></td>
								<%} %>						
							</tr>
						</tbody>

		...
		<nav class="navbar navbar-expand-lg navbar-dark px-5 py-3 py-lg-0">
			...
			<div class="collapse navbar-collapse" id="navbarCollapse">
				<div class="navbar-nav ms-auto py-0">
					<a href="ADMIN.JSP" class="nav-item nav-link active">Home</a> <a
						href="NewCustomer.jsp" class="nav-item nav-link">New Customer</a>
					<a href="CustomerDetails.jsp" class="nav-item nav-link">Customer
						Details</a> <a href="DepositeDetails.jsp" class="nav-item nav-link">Deposite
						Details</a> <a href="CalculateBill.jsp" class="nav-item nav-link">Calculate
						Bill</a>
				</div>

		...
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-md-10 col-xs-10"
					...
					<h1 style="color: rgba(22, 123, 162, 0.79);" class="mb-2">Customer
						details</h1>
					<table class="table table-hover">
						...
						<tbody>
							<tr>
								...
								<td><a
									href="DeleteRecord?del=delete&&cno=<%=rs.getString("cno")%>">
										<button type="button" class="btn btn-danger delete">Delete</button>
								</a></td>

								<td><a
									href="CalculateBill?cno=<%=rs.getString("cno")%>">
										<button type="button" class="btn btn-danger delete">Generate
											Bill</button>
								</a></td>
...
if(status=="success"){
	swal("Congrats"," Bill Generated Successfully","success");
}
else if(status=="failed"){
	swal("Sorry","This Month Bill Alrady Generated..","error");
}

...
<input type ="hidden" id="status" value="<%= request.getAttribute("status")%>">
        ...
        <div class="row gx-0">
            <div class="col-lg-8 text-center text-lg-start mb-2 mb-lg-0">
                <div class="d-inline-flex align-items-center" style="height: 45px;">
                    <small class="me-3 text-light"><i class="fa fa-mobile fa-2x" aria-hidden="true"></i>
                        +91 20 46703126</small>
                    <small class="text-light"><i class="fa fa-envelope-open me-2"></i>
                        info@orientconsultancy.com</small>
                </div>
            </div>
    ...
    <div class="container-fluid position-relative p-0">
        <nav class="navbar navbar-expand-lg navbar-dark px-5 py-3 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <!-- 
                <li>
                 <a href="logout" class="btn btn-primary py-2 px-4 ms-3">Log out</a> 
                 </li>
                  -->
                 <li>
                 <a href="logout" class="btn btn-primary py-2 px-4 ms-3"><%=session.getAttribute("name") %></a> 
                 </li>
            </div>
        </nav>
                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h1 class="display-1 text-white mb-md-4 animated zoomIn">Pay Your Bill Online</h1>
                            <h5 class="text-white text-uppercase mb-3 animated slideInDown">Pay online<br> Save Your
                                Time</h5>
                            <a href="NewConnection.jsp"
                                class="btn btn-primary mt-3 py-md-2 px-md-3 me-3 animated slideInLeft">
                                Our Services</a>
                            <a href="contact.jsp" class="btn btn-outline-light mt-3 py-md-2 px-md-3 animated slideInRight">Contact
                                Us</a>
                        </div>
                    </div>
                </div>
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            ...
                            <a href="NewConnection.jsp" class="btn btn-primary py-md-2 px-md-2 me-3 animated slideInLeft">Our
                                Services</a>
                            <a href="contact.jsp"
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            ...
                            <a href="NewConnection.jsp" class="btn btn-primary py-md-2 px-md-3 me-3 animated slideInLeft">Our
                                Services</a>
                            <a href="contact.jsp"
                                class="btn btn-outline-light py-md-2 px-md-3 animated slideInRight">Contact
                                Us</a>
    ...
    <div class="blog-area fix bg-color area-padding-2 mt-2" style="background-color:rgb(255, 255, 255)"><br>
        <div class="container">
            <div class="row">
                    ...
                    <div class="">
                        <div class="blog-content">
                            ...
                            <p style="color:#ac5d1c;">
                                Orient Consultancy is a leading provider of Internet solutions with services such as
                                e-Commerce solutions, Web development, web applications, Multimedia and Design
                                Solutions, Software development and Wireless technologies / mobile game development.

                                <br><br>
                                At Orient Consultancy, we know that it's more than the products we design and
                                implement.
                                Orient is backed by a team of committed, experienced and qualified professionals.
                                The team is the firm's biggest asset. <a href="about.html">Read More</a>
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <!-- /* *************************************************************** */ -->
    <div class="blog-area fix bg-color  mt-5"
        style="background-image: url(img/images/common-start-prj-bg.jpg);padding: 20px 0px 20px;">
        <div class="container">
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="single-well mar-well"><br>
                        <h4 style="color:white">What We Do?</h4>

                        <p style="color:white">msebonlinebillpayment.com provides comprehensive step-by-step tutorials, general tips, and answers to commonly asked questions related to the subject the website cover. I hope what I present in front of you will help you to make your life easier at least a tiny bit.</p>
                        <a class="contact-button" style="background-color:black" href="contact.html">Contact us</a>
                        ...
                        <div class="card">
                            <a href="#">
                                <div class="card-image spl-image mt-3">
                                    <img src="img/electric-smile.jpg" alt="VSD" style="border-radius: 10px;">
                                </div>
                                <div class="card-content mt-3">
                                    <h3>Electric Smiles</h3>
                                    <p>Get 2% loyalty points on every bill payment at Adani electricity online platforms
                                    </p>
            ...
            <div class="col-md-3">
                <div class="owl-item active">
                    <div class="card">
                        <a href="#">
                            <div class="card-image spl-image mt-3">
                                <img src="img/Energy Wizard.jpg" alt="VSD" style="border-radius: 10px;">
                            </div>
                            <div class="card-content mt-3">
                                <h4>Energy Wizard</h4>
                                <p>Learn how to optimize energy useage for maximum benefits.
                                </p>
                                <span class="link-btn">Know More </span>
                            </div>
                        </a>
            ...
            <div class="col-md-3">
                <div class="owl-item active">
                    <div class="card">
                        <a href="#">
                            <div class="card-image spl-image mt-3">
                                <img src="img/Simple Ways to Save.jpg" alt="VSD" style="border-radius: 10px;">
                            </div>
                            <div class="card-content mt-3">
                                <h4>Simple ways to save</h4>
                                <p>Simplest tips and trics to bring down your energy consuption and bill.
                                </p>
                                <span class="link-btn">Know More </span>
                            </div>
                        </a>
            ...
            <div class="col-md-3">
                <div class="owl-item active">
                    <div class="card">
                        <a href="#">
                            <div class="card-image spl-image mt-3">
                                <img src="img/Energy Calculator.jpg" alt="VSD" style="border-radius: 10px;">
                            </div>
                            <div class="card-content mt-3">
                                <h4>Energy Calculator </h4>
                                <p>Give us little information and we shall calculate your energy requriment.
                                </p>
                                <span class="link-btn">Know More </span>
                            </div>
                        </a>
            ...
            <div class="col-md-3">
                <div class="owl-item active">
                    <div class="card">
                        <a href="#">
                            <div class="card-image spl-image mt-3">
                                <img src="img/What Products to Buy.jpg" alt="VSD" style="border-radius: 10px;">
                            </div>
                            <div class="card-content mt-3">
                                <h4>What Product to Buy</h4>
                                <p>Check how to choose energy efficient Electrical appliances
                                </p>
                                <span class="link-btn">Know More </span>
                            </div>
                        </a>
            ...
            <div class="row gx-5" id="footer-containers">
                ...
                <div class="col-md-3 col-sm-4 col-xs-12 pt-0 pt-lg-5 mb-5">
                    ...
                    <div class="link-animated d-flex flex-column justify-content-start">
                        ...
                        <a class="text-light mb-2" href="about.jsp"><i
                                class="bi bi-arrow-right text-primary me-2"></i>About
                            Us</a>
                        <a class="text-light" href="contact.jsp"><i
